...
@resume_bp.route("/grammar-check", methods=["POST"])
@rate_limit(10, 60)
def grammar_check():
...
def e404(e): return render_template("resume/error.html", message="Page not found."), 404
@resume_bp.errorhandler(413)
def e413(e): return render_template("resume/error.html", message="File too large (max 5MB)."), 413
